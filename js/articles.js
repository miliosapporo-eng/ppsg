const articlesData = [
    // 最新の記事を一番上にしてください
    {
        ...
        url: '/journal/260305.html' // 直接のファイルパスを指定
    },
    {
        id: 'exposure-ritual',
        category: 'Technique',
        ...
        url: '/journal/exposure-ritual.html'
    },
    {
        id: 'model-mirror',
        category: 'Interview',
    ...
    },
    {
        ...
        url: '/journal/lens-aberration.html'
    },
    {
        ...
        url: '/journal/monochrome-structure.html'
    },
    {
        id: 'silence-fieldnote',
        category: 'Philosophy', // GalleryからPhilosophyへ例として変更（フィルタ動作確認用）
        subCategory: 'Review',
        date: '2024.02.20',
        title: '沈黙を撮るためのフィールドノート',
        excerpt: '音のない風景に耳を澄ませる。静寂という概念を視覚化するために必要な、精神的な準備とアプローチの記録。',
        image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=800',
        url: '/journal/silence-fieldnote.html'
    }
];
